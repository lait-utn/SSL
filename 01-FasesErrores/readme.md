...
> cpp hello3.c > hello3.i   
5) Se observa que hello3.i no posee todas las declaraciones de la libreria stdio y varios #define que hello2.i si posee   
6)   
> gcc -S hello3.i    
